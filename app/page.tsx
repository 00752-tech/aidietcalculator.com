...
// Using the fallback (?? mod.default) ensures these work regardless of export style
...
const BodyFatPercentageCalculator = dynamic(() => import('@/components/body-fat-percentage-calculator').then(mod => mod.BodyFatPercentageCalculator ?? mod.default), { ssr: false })
