...
{/* Sleep Affiliate Offer: ChiliPad */}
<Card className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 shadow-lg my-12 p-6 relative overflow-hidden hover:shadow-xl transition duration-300">
  ...
  <CardContent className="text-gray-800 space-y-4 text-[17px] leading-relaxed">
    ...
    <button
      ...
      className="group w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-5 rounded-md flex items-center justify-center gap-2 transition duration-300 animate-pulse hover:animate-none"
    >
...
{/* Sleep Affiliate Offer: Sleep Revive */}
<Card className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 shadow-lg my-12 p-6 relative overflow-hidden hover:shadow-xl transition duration-300">
  ...
  <CardContent className="text-gray-800 space-y-4 text-[17px] leading-relaxed">
    ...
    <button
      ...
      className="group w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-5 rounded-md flex items-center justify-center gap-2 transition duration-300 animate-pulse hover:animate-none"
    >
