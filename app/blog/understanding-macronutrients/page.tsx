...
export const metadata: Metadata = {
  ...
  description: 'Learn how to optimize your diet with AI-assisted precision. Explore proteins, carbs, and fats for better health and weight management.',
  keywords: ['macronutrients', 'balanced nutrition', 'AI diet', 'proteins', 'carbohydrates', 'fats', 'weight management'],
}

export default function BlogPost() {
  const post = blogPosts.find((post) => post.slug === "understanding-macronutrients")
