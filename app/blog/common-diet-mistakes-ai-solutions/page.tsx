...
export const metadata: Metadata = {
  ...
  description: "Discover how AI-powered tools can guide you towards effective weight management by helping you avoid common dieting pitfalls.",
  keywords: ['diet mistakes', 'AI diet tools', 'weight management', 'AI nutrition', 'dieting pitfalls'],
}

export default function BlogPost() {
  const post = blogPosts.find((post) => post.slug === "common-diet-mistakes-ai-solutions")
