...
export const metadata: Metadata = {
  ...
  description: 'Explore how AI revolutionizes meal planning for effective, sustainable weight loss tailored to individual needs and preferences.',
  keywords: ['AI meal planning', 'personalized diet', 'weight loss', 'nutrition technology', 'custom meal plans'],
}

export default function BlogPost() {
  const post = blogPosts.find((post) => post.slug === "ai-personalized-meal-planning-weight-loss")
