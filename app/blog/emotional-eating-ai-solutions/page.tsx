...
export const metadata: Metadata = {
  ...
  description: "Explore AI-powered tools that help identify and overcome emotional eating patterns, leading to effective weight management and improved mental health.",
  keywords: ['emotional eating', 'AI technology', 'weight management', 'mental health', 'AI diet support'],
}

export default function BlogPost() {
  const post = blogPosts.find((post) => post.slug === "emotional-eating-ai-solutions")
