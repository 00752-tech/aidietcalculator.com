...
export default function CalorieAffiliateCards() {
  return (
    <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
      ...
      <Card className="bg-gradient-to-br from-gray-50 to-sky-50 border border-sky-100 shadow-md p-6 relative transition duration-300 hover:shadow-lg flex flex-col justify-between">
      ...
      {/* 2. Lean Body Tonic */}
      <Card className="bg-gradient-to-br from-gray-50 to-orange-50 border border-orange-100 shadow-md p-6 relative transition duration-300 hover:shadow-lg flex flex-col justify-between">
      ...
      <Card className="bg-gradient-to-br from-gray-50 to-indigo-50 border border-indigo-100 shadow-md p-6 relative transition duration-300 hover:shadow-lg flex flex-col justify-between">
