...
export default function ProteinAffiliateCards() {
  return (
    <div className="flex flex-wrap gap-6 justify-center mt-10">
      {/* 1. Beautify Collagen */}
      <Card className="w-[320px] bg-gradient-to-br from-gray-50 to-pink-50 border border-pink-100 shadow-md p-6 relative hover:shadow-lg transition">
        ...
        <CardContent className="text-[17px] text-gray-800 space-y-4">
          ...
          <a
            ...
            className="group w-full bg-pink-600 hover:bg-pink-700 text-white font-semibold py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors duration-300"
          >
            Try Beautify Collagen
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
          </a>
          <div className="flex justify-center items-center gap-1 text-sm text-pink-700">
      ...
      <Card className="w-[320px] bg-gradient-to-br from-gray-50 to-green-50 border border-green-100 shadow-md p-6 relative hover:shadow-lg transition">
        ...
        <CardContent className="text-[17px] text-gray-800 space-y-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors duration-300"
          >
            Try Daily Greens
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
          </a>
          <div className="flex justify-center items-center gap-1 text-sm text-green-700">
            <ShieldCheck className="w-4 h-4" />
      ...
      <Card className="w-[320px] bg-gradient-to-br from-gray-50 to-purple-50 border border-purple-100 shadow-md p-6 relative hover:shadow-lg transition">
        ...
        <CardContent className="text-[17px] text-gray-800 space-y-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded flex items-center justify-center gap-2 transition-colors duration-300"
          >
            Try Plant Protein
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" />
          </a>
          <div className="flex justify-center items-center gap-1 text-sm text-purple-700">
            <ShieldCheck className="w-4 h-4" />
      ...
      <Card className="w-[320px] bg-gradient-to-br from-gray-50 to-indigo-50 border border-indigo-100 shadow-md p-6 relative hover:shadow-lg transition">
        ...
        <CardContent className="text-[17px] text-gray-800 space-y-4">
          ...
          <div className="flex justify-center items-center gap-1 text-sm text-indigo-700">
            <ShieldCheck className="w-4 h-4" />
