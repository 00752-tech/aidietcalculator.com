    ...
    <>
      ...
      <div className="max-w-2xl mx-auto mb-6 px-4">
        <p className="text-lg text-gray-800 bg-white bg-opacity-80 rounded-md p-4 shadow-sm border border-gray-200">
          <strong>Get your personalized daily water intake recommendation quickly and easily with our AI-Enhanced Water Intake Calculator.</strong> Simply enter your weight (in pounds or kilograms), select your activity level (sedentary, moderate, active, or very active), and choose your climate (cold, moderate, or hot). Our tool uses advanced algorithms to provide recommendations based on your unique factors, helping you maintain optimal hydration for better health and performance. You'll receive your recommended daily water intake in both liters and fluid ounces.
        </p>
      </div>
