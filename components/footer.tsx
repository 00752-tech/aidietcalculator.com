...
export function Footer() {
  ...
  return (
    <footer className="mt-20 bg-gray-100 dark:bg-gray-800 py-12">
      <div className="container mx-auto px-4">
        
        {/* SEO HOARDING ZONE: Kept here for search crawlers, invisible to conversion flow */}
        <div className="mb-12 border-b border-gray-200 pb-12">
          <h2 className="text-center font-bold text-gray-800 dark:text-gray-200 mb-6 uppercase tracking-wider text-sm">
